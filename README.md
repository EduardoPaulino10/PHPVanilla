...
### Semana 7 - Segurança no BackEnd - Sanitização, Validação e Proteção con XSS
...
4. *Captura de Teclas(KeyLoger)*: Grava tudo que a vítima digita enquanto a página estiver aberta.
